...
from tpoint.io import read_azel_datfile, read_raw_datfile


def test_read_azel_datfile():
    proc_file = pkg_resources.resource_filename("tpoint", os.path.join("test_data", "k_and_e.dat"))
    raw_file = pkg_resources.resource_filename("tpoint", os.path.join("test_data", "point_20210821.dat"))
